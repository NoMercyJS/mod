...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        let embed = new Discord.MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true })).setColor('#2F3136').setFooter('Rash Was Here').setTimestamp()
